...
// Cache upstream GitHub responses for 60s at the data-fetch layer so the streak
// and stats stay near-live. Even at one revalidation/minute the per-year
// fan-out stays well under the PAT's ~5000/hr GraphQL budget, and real traffic
// is far below that ceiling because the rendered card is itself cached.
...
// GitHub GraphQL results in the Data Cache for 60s, independent of how often the
