...
import { RC_GAME_ID } from "./multiplayer";
...
export const Lobby = ({ onOnline, onSameDevice }) => {
  ...
  const create = useCallback(async () => {
    ...
    const result = await createRoom({ game: RC_GAME_ID });
    if (result.ok) {
  ...
  return (
    <Panel>
      <PanelHeading>Race Condition</PanelHeading>
      <PanelText>
        Slide one of your opponent&rsquo;s marbles, place one of your own, and
        the whole board turns one position. Four in a row after the turn wins.
      </PanelText>
