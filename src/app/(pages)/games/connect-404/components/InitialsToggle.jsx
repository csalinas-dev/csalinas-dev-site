...
// Shows or hides the initial on this browser's pieces, and nothing else. The
// preference is shared with Race Condition and remembered per browser; it never
...
export const InitialsToggle = () => {
  ...
  return (
    <Button
      ...
      onClick={toggle}
      title="Stamp each piece with its player's initial"
      type="button"
    >
