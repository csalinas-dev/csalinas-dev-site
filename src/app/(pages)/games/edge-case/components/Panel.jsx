...
// lobby, a lost connection. They share one shell so moving between them never
// shifts the layout, and so all of them sit where the board would (same flex
// growth, same top padding to clear the toolbar).
